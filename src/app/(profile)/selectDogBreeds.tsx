...
import DogBreedItem from "../../components/BreedItem/DogBreedItem";
    ...
    <View style={[styles.container, { paddingBottom: insets.bottom }]}>
      <View style={styles.iconsContainer}>
        ...
        <View style={styles.selectAllEraseIconsContainer}>
          <Pressable style={styles.iconButton} onPress={selectAllDogBreeds}>
          ...
          <Pressable
            onPress={clearSelectedDogBreeds}
...
export default SelectDogBreeds;
